...
#let section(title) = {
    text(12pt,font: font_section, fill: headings_colour,weight: "light", )[#upper[#title]\ ]
}
...
#let jobdetail(content) = {
    text(11pt,font: font_jobdetail, fill: primary_colour,weight: "light", baseline: 0em )[#set enum(tight:false,spacing:0em,indent: 0em, body-indent: 0em)
    #content ]
}
// Details
#let info(content) = {
...
#let reference(name, department, firm, address, email) = {
    align(left,{text(11pt, font: font_section, fill: subheadings_colour,weight: "semibold",)[#name\ ]
